//===-- ElbrusTargetTransformInfo.cpp - Elbrus specific TTI pass ----------------===//
//
...
/// the numbers correspond to some "generic" Elbrus CPU instead of usage of a
...
#define HasSSE1( ST) (true)
#define HasSSE2( ST) (true)
#define HasSSE3( ST) (true)
#define HasSSSE3( ST) (true)
#define HasSSE41( ST) (true)
#define HasSSE42( ST) (true)
#define HasAVX( ST) (true)
#define HasAVX2( ST) (true)
#define HasAVX512( ST) (true)
#define HasXOP( ST) (false)
#define HasDQI( ST) (false)
#define UseAVX512Regs( ST) (false)
...
ElbrusTTIImpl::getPopcntSupport(unsigned TyWidth) {
  assert(isPowerOf2_32(TyWidth) && "Ty width must be power of 2");
  return TargetTransformInfo::PopcntSupportKind::PSK_FastHardware;
}

std::optional<unsigned> ElbrusTTIImpl::getCacheSize(
...
std::optional<unsigned> ElbrusTTIImpl::getCacheAssociativity(
  TargetTransformInfo::CacheLevel Level) const {
  //   - Penryn
  //   - Nehalem
  //   - Westmere
...
unsigned ElbrusTTIImpl::getNumberOfRegisters(unsigned ClassID) const {
  return 128;
}

TypeSize
ElbrusTTIImpl::getRegisterBitWidth(TargetTransformInfo::RegisterKind K) const {
  switch (K) {
  case TargetTransformInfo::RGK_Scalar:
    return TypeSize::getFixed(true ? 64 : 32);
...
unsigned ElbrusTTIImpl::getLoadStoreVecRegBitWidth(unsigned) const {
  return getRegisterBitWidth(TargetTransformInfo::RGK_FixedWidthVector)
      .getFixedValue();
}

unsigned ElbrusTTIImpl::getMaxInterleaveFactor(ElementCount VF) {
...
InstructionCost ElbrusTTIImpl::getArithmeticInstrCost(
  ...
  if (ISD == ISD::MUL && Args.size() == 2 && LT.second.isVector() &&
    ...
    if (OpMinSize <= 15 && false &&
      ...
      bool Op1Sext = isa<SExtInst>(Args[0]) &&
                     (Op1MinSize == 15 || (Op1MinSize < 15 && !HasSSE41( ST)));
      bool Op2Sext = isa<SExtInst>(Args[1]) &&
                     (Op2MinSize == 15 || (Op2MinSize < 15 && !HasSSE41( ST)));
  ...
  // On Elbrus, vector signed division by constants power-of-two are
  ...
  if (Op2Info.isUniform() && Op2Info.isConstant() && false)
    if (const auto *Entry =
  ...
  if (Op2Info.isUniform() && Op2Info.isConstant() && HasAVX512( ST))
    if (const auto *Entry =
  ...
  if (Op2Info.isUniform() && Op2Info.isConstant() && HasAVX2( ST))
    if (const auto *Entry =
  ...
  if (Op2Info.isUniform() && Op2Info.isConstant() && HasAVX( ST) &&
      (!HasXOP( ST) || LT.second.getScalarSizeInBits() != 8))
    if (const auto *Entry =
  ...
  // XOP has faster vXi8 shifts.
  if (Op2Info.isUniform() && Op2Info.isConstant() && HasSSE2( ST) &&
      (!HasXOP( ST) || LT.second.getScalarSizeInBits() != 8))
    if (const auto *Entry =
  ...
  if (Op2Info.isConstant() && HasAVX512( ST))
    if (const auto *Entry =
  ...
  if (Op2Info.isConstant() && HasAVX2( ST))
  ...
  if (Op2Info.isConstant() && HasAVX( ST))
  ...
  if (Op2Info.isConstant() && HasSSE41( ST))
    if (const auto *Entry =
  ...
  if (Op2Info.isConstant() && HasSSE2( ST))
  ...
  if (HasAVX512( ST) && Op2Info.isUniform())
    if (const auto *Entry =
  ...
  if (HasAVX2( ST) && Op2Info.isUniform())
    if (const auto *Entry =
  ...
  // XOP has faster vXi8 shifts.
  if (HasAVX( ST) && Op2Info.isUniform() &&
      (!HasXOP( ST) || LT.second.getScalarSizeInBits() != 8))
    if (const auto *Entry =
  ...
  if (HasSSE2( ST) && Op2Info.isUniform() &&
      (!HasXOP( ST) || LT.second.getScalarSizeInBits() != 8))
    if (const auto *Entry =
  ...
  static const CostKindTblEntry AVX512CostTable[] = {
    ...
    //{ ElbrusISD::PMULUDQ, MVT::v8i64, { 1,  5, 1, 1 } },
  ...
  if (HasAVX2( ST) && !(HasXOP( ST) && LT.second == MVT::v4i32)) {
  ...
  if (ISD == ISD::SHL && !Op2Info.isUniform() && Op2Info.isConstant()) {
    ...
    if (((VT == MVT::v8i16 || VT == MVT::v4i32) && HasSSE2( ST)) ||
        ((VT == MVT::v16i16 || VT == MVT::v8i32) && HasAVX( ST)))
      ISD = ISD::MUL;
  }
  ...
  static const CostKindTblEntry AVX2CostTable[] = {
    ...
    //{ ElbrusISD::PMULUDQ, MVT::v4i64, { 1,  5, 1, 1 } },
  ...
  static const CostKindTblEntry SSE2CostTable[] = {
    ...
    //{ ElbrusISD::PMULUDQ, MVT::v2i64, { 1,  5, 1, 1 } },
  ...
  static const CostKindTblEntry ElbrusCostTbl[] = { // 32 or 64-bit targets
  ...
  if (const auto *Entry = CostTableLookup(ElbrusCostTbl, ISD, LT.second))
    if (auto KindCost = Entry->Cost[CostKind])
      return LT.first * *KindCost;
...
InstructionCost
ElbrusTTIImpl::getAltInstrCost(VectorType *VecTy, unsigned Opcode0,
...
InstructionCost ElbrusTTIImpl::getShuffleCost(
  ...
  if (Kind == TTI::SK_ExtractSubvector && LT.second.isVector()) {
    ...
    if (SubLT.second.isVector()) {
      ...
      if (NumSubElts > OrigSubElts && (Index % OrigSubElts) == 0 &&
        ...
        if (SubTp->getPrimitiveSizeInBits() >= 32 || HasSSSE3( ST))
...
InstructionCost ElbrusTTIImpl::getCastInstrCost(unsigned Opcode, Type *Dst,
                                             Type *Src,
...
InstructionCost ElbrusTTIImpl::getCmpSelInstrCost(unsigned Opcode, Type *ValTy,
                                               Type *CondTy,
  ...
  if (Opcode == Instruction::ICmp || Opcode == Instruction::FCmp) {
    ...
    if (MTy.isVector() &&
        !((HasXOP( ST) && (!HasAVX2( ST) || MTy.is128BitVector())) ||
          (HasAVX512( ST) && 32 <= MTy.getScalarSizeInBits()) ||
          false)) {
      ...
      case CmpInst::Predicate::ICMP_UGE:
        if ((HasSSE41( ST) && MTy.getScalarSizeInBits() == 32) ||
            (HasSSE2( ST) && MTy.getScalarSizeInBits() < 32)) {
          // cmpeq(psubus(x,y),0)
          // cmpeq(pminu(x,y),x)
          ExtraCost = 1;
        } else {
...
unsigned ElbrusTTIImpl::getAtomicMemIntrinsicMaxElementSize() const { return 16; }

InstructionCost
ElbrusTTIImpl::getIntrinsicInstrCost(const IntrinsicCostAttributes &ICA,
                                  TTI::TargetCostKind CostKind) {
  // Costs should match the codegen from:
  // BITREVERSE: llvm\test\CodeGen\Elbrus\vector-bitreverse.ll
  // BSWAP: llvm\test\CodeGen\Elbrus\bswap-vector.ll
  // CTLZ: llvm\test\CodeGen\Elbrus\vector-lzcnt-*.ll
  // CTPOP: llvm\test\CodeGen\Elbrus\vector-popcnt-*.ll
  // CTTZ: llvm\test\CodeGen\Elbrus\vector-tzcnt-*.ll
  ...
  if (ISD != ISD::DELETED_NODE) {
    ...
    if (ISD == ISD::BITREVERSE && false && HasSSSE3( ST) &&
        MTy.isVector()) {
      ...
      if (!(MTy.is128BitVector() || (HasAVX2( ST) && MTy.is256BitVector()) ||
            (false && MTy.is512BitVector())))
        Cost = Cost * 2 + 2;
    ...
    if (const auto *Entry = CostTableLookup(ElbrusCostTbl, ISD, MTy))
      if (auto KindCost = Entry->Cost[CostKind])
...
InstructionCost ElbrusTTIImpl::getVectorInstrCost(unsigned Opcode, Type *Val,
  ...
  if (Index != -1U && (Opcode == Instruction::ExtractElement ||
    ...
    auto IsCheapPInsrPExtrInsertPS = [&]() {
      ...
      return (MScalarTy == MVT::i16 && HasSSE2( ST)) ||
             (MScalarTy.isInteger() && HasSSE41( ST)) ||
             (MScalarTy == MVT::f32 && HasSSE41( ST) &&
              Opcode == Instruction::InsertElement);
    };
...
InstructionCost
ElbrusTTIImpl::getScalarizationOverhead(VectorType *Ty, const APInt &DemandedElts,
  ...
  if (Insert) {
    if ((MScalarTy == MVT::i16 && HasSSE2( ST)) ||
        (MScalarTy.isInteger() && HasSSE41( ST)) ||
        (MScalarTy == MVT::f32 && HasSSE41( ST))) {
  ...
  if (Extract) {
    ...
    if (!Insert && Ty->getScalarSizeInBits() == 1 && !HasAVX512( ST)) {
      unsigned NumElts = cast<FixedVectorType>(Ty)->getNumElements();
      unsigned MaxElts = HasAVX2( ST) ? 32 : 16;
...
InstructionCost
ElbrusTTIImpl::getReplicationShuffleCost(Type *EltTy, int ReplicationFactor,
...
InstructionCost ElbrusTTIImpl::getMemoryOpCost(unsigned Opcode, Type *Src,
...
InstructionCost
ElbrusTTIImpl::getMaskedMemoryOpCost(unsigned Opcode, Type *SrcTy, Align Alignment,
                                  unsigned AddressSpace,
                                  TTI::TargetCostKind CostKind) {
...
InstructionCost
ElbrusTTIImpl::getPointersChainCost(ArrayRef<const Value *> Ptrs,
                                 const Value *Base,
  ...
  if (Info.isSameBase() && Info.isKnownStride()) {
    ...
    // into constants. Elbrus memory addressing allows encoding it into
...
InstructionCost ElbrusTTIImpl::getAddressComputationCost(Type *Ty,
                                                      ScalarEvolution *SE,
                                                      const SCEV *Ptr) {
  ...
  // modes of Elbrus regardless of the stride value. We dont believe that there
  ...
  // ADD instruction.
  if (Ty->isVectorTy() && SE && !HasAVX2( ST)) {
...
InstructionCost
ElbrusTTIImpl::getArithmeticReductionCost(unsigned Opcode, VectorType *ValTy,
...
InstructionCost ElbrusTTIImpl::getMinMaxCost(Intrinsic::ID IID, Type *Ty,
                                          TTI::TargetCostKind CostKind,
                                          FastMathFlags FMF) {
...
InstructionCost
ElbrusTTIImpl::getMinMaxReductionCost(Intrinsic::ID IID, VectorType *ValTy,
                                   FastMathFlags FMF,
                                   TTI::TargetCostKind CostKind) {
  std::pair<InstructionCost, MVT> LT = getTypeLegalizationCost(ValTy);
...
InstructionCost ElbrusTTIImpl::getIntImmCost(int64_t Val) {
  if (Val == 0)
    return TTI::TCC_Free;
...
InstructionCost ElbrusTTIImpl::getIntImmCost(const APInt &Imm, Type *Ty,
                                          TTI::TargetCostKind CostKind) {
...
InstructionCost ElbrusTTIImpl::getIntImmCostInst(unsigned Opcode, unsigned Idx,
  ...
  if (Idx == ImmIdx) {
    ...
    InstructionCost Cost = ElbrusTTIImpl::getIntImmCost(Imm, Ty, CostKind);
    return (Cost <= NumConstants * TTI::TCC_Basic)
               ? static_cast<int>(TTI::TCC_Free)
               : Cost;
  }

  return ElbrusTTIImpl::getIntImmCost(Imm, Ty, CostKind);
}

InstructionCost ElbrusTTIImpl::getIntImmCostIntrin(Intrinsic::ID IID, unsigned Idx,
                                                const APInt &Imm, Type *Ty,
                                                TTI::TargetCostKind CostKind) {
  assert(Ty->isIntegerTy());
...
InstructionCost ElbrusTTIImpl::getCFInstrCost(unsigned Opcode,
                                           TTI::TargetCostKind CostKind,
                                           const Instruction *I) {
  if (CostKind != TTI::TCK_RecipThroughput)
...
int ElbrusTTIImpl::getGatherOverhead() const {
  return 1024;
}

int ElbrusTTIImpl::getScatterOverhead() const {
  return 1024;
}

// Return an average cost of Gather / Scatter instruction, maybe improved later.
InstructionCost ElbrusTTIImpl::getGSVectorCost(unsigned Opcode, TTI::TargetCostKind CostKind,
...
InstructionCost ElbrusTTIImpl::getGatherScatterOpCost(
...
bool ElbrusTTIImpl::isLSRCostLess(const TargetTransformInfo::LSRCost &C1,
                               const TargetTransformInfo::LSRCost &C2) {
    // Elbrus specific here are "instruction number 1st priority".
...
bool ElbrusTTIImpl::canMacroFuseCmp() {
  return false || false;
}

bool ElbrusTTIImpl::isLegalMaskedLoad(Type *DataTy, Align Alignment) {
  return false;
}

bool ElbrusTTIImpl::isLegalMaskedStore(Type *DataType, Align Alignment) {
  return isLegalMaskedLoad(DataType, Alignment);
}

bool ElbrusTTIImpl::isLegalNTLoad(Type *DataType, Align Alignment) {
  unsigned DataSize = DL.getTypeStoreSize(DataType);
  // The only supported nontemporal loads are for aligned vectors of 16 or 32
  // bytes.  Note that 32-byte nontemporal vector loads are supported by AVX2
  // (the equivalent stores only require AVX).
  if (Alignment >= DataSize && (DataSize == 16 || DataSize == 32))
    return DataSize == 16 ?  HasSSE1( ST) : HasAVX2( ST);

  return false;
}

bool ElbrusTTIImpl::isLegalNTStore(Type *DataType, Align Alignment) {
  unsigned DataSize = DL.getTypeStoreSize(DataType);

  // SSE4A supports nontemporal stores of float and double at arbitrary
  // alignment.
  if (false && (DataType->isFloatTy() || DataType->isDoubleTy()))
    return true;
...
bool ElbrusTTIImpl::isLegalBroadcastLoad(Type *ElementTy,
                                      ElementCount NumElements) const {
  // movddup
  return HasSSE3( ST) && !NumElements.isScalable() &&
         NumElements.getFixedValue() == 2 &&
         ElementTy == Type::getDoubleTy(ElementTy->getContext());
}

bool ElbrusTTIImpl::isLegalMaskedExpandLoad(Type *DataTy) {
  return false;
}

bool ElbrusTTIImpl::isLegalMaskedCompressStore(Type *DataTy) {
  return isLegalMaskedExpandLoad(DataTy);
}

bool ElbrusTTIImpl::supportsGather() const {
  return false;
}

bool ElbrusTTIImpl::forceScalarizeMaskedGather(VectorType *VTy, Align Alignment) {
  return false;
}

bool ElbrusTTIImpl::isLegalMaskedGatherScatter(Type *DataTy, Align Alignment) {
  return (false);
}

bool ElbrusTTIImpl::isLegalMaskedGather(Type *DataTy, Align Alignment) {
  return false;
}

bool ElbrusTTIImpl::isLegalAltInstr(VectorType *VecTy, unsigned Opcode0,
                                 unsigned Opcode1,
  ...
  if (ElemTy->isFloatTy())
    return HasSSE3( ST) && NumElements % 4 == 0;
  if (ElemTy->isDoubleTy())
    return HasSSE3( ST) && NumElements % 2 == 0;
  return false;
}

bool ElbrusTTIImpl::isLegalMaskedScatter(Type *DataType, Align Alignment) {
  return false;
}

bool ElbrusTTIImpl::hasDivRemOp(Type *DataType, bool IsSigned) {
  EVT VT = TLI->getValueType(DL, DataType);
  return TLI->isOperationLegal(IsSigned ? ISD::SDIVREM : ISD::UDIVREM, VT);
}

bool ElbrusTTIImpl::isExpensiveToSpeculativelyExecute(const Instruction* I) {
...
bool ElbrusTTIImpl::isFCmpOrdCheaperThanFCmpZero(Type *Ty) {
  return false;
}

bool ElbrusTTIImpl::areInlineCompatible(const Function *Caller,
...
bool ElbrusTTIImpl::areTypesABICompatible(const Function *Caller,
  ...
  if (UseAVX512Regs( TM.getSubtarget<ElbrusSubtarget>(*Caller)) ==
      UseAVX512Regs( TM.getSubtarget<ElbrusSubtarget>(*Callee)))
    return true;
...
ElbrusTTIImpl::TTI::MemCmpExpansionOptions
ElbrusTTIImpl::enableMemCmpExpansion(bool OptSize, bool IsZeroCmp) const {
  ...
  if (IsZeroCmp) {
    ...
    const unsigned PreferredWidth = 128;
    if (PreferredWidth >= 512 && HasAVX512( ST)) Options.LoadSizes.push_back(64);
    if (PreferredWidth >= 256 && HasAVX( ST)) Options.LoadSizes.push_back(32);
    if (PreferredWidth >= 128 && HasSSE2( ST)) Options.LoadSizes.push_back(16);
  }
  if (true) {
...
bool ElbrusTTIImpl::prefersVectorizedAddressing() const {
  return supportsGather();
}

bool ElbrusTTIImpl::supportsEfficientVectorElementLoadStore() const {
  return false;
}

bool ElbrusTTIImpl::enableInterleavedAccessVectorization() {
...
InstructionCost ElbrusTTIImpl::getInterleavedMemoryOpCostAVX512(
  ...
  if (Opcode == Instruction::Load) {
    ...
    // ElbrusInterleavedAccess pass will generate.
    // The cost of loads and stores are computed separately from the table.

    // ElbrusInterleavedAccess support only the following interleaved-access group.
...
InstructionCost ElbrusTTIImpl::getInterleavedMemoryOpCost(
  ...
  if (HasAVX512( ST) && isSupportedOnAVX512(VecTy))
...
InstructionCost ElbrusTTIImpl::getScalingFactorCost(Type *Ty, GlobalValue *BaseGV,
                                                 int64_t BaseOffset,
  ...
  //
  // For some Elbrus architectures, this is even worse because for instance for
